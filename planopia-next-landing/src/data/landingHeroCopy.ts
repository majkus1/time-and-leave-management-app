export const landingHeroCopy = {
	pl: {
		...
		askAssistantLead: 'Masz pytanie?',
		askAssistant: 'Zapytaj asystenta, jak działa Planopia',
	...
	en: {
		...
		askAssistantLead: 'Have a question?',
		askAssistant: 'Ask the assistant how Planopia works',
