...
export const planOfferingCopy = {
	pl: {
		...
		metaShort:
			'Ewidencja czasu pracy, urlopy i zadania bez Excela. 30 dni pełnej aplikacji za darmo, potem darmowa ewidencja do 5 kont lub pakiety z grafikami, raportami i AI.',
		...
		heroH1: 'Ewidencja czasu pracy, urlopy i grafiki bez Excela',
		heroSub:
	...
	en: {
		...
		metaShort:
			'Time tracking, leave, and tasks without spreadsheets. 30-day full trial, then free time tracking for up to 5 accounts or paid plans with schedules, reports, and AI.',
		jsonLdOfferDescription:
		...
		heroH1: 'Time tracking, leave, and schedules without spreadsheets',
		heroSub:
