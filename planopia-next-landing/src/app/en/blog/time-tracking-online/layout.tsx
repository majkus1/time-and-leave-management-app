...
export const metadata: Metadata = {
  ...
  description: "Discover how to track working hours online. Planopia automates employee attendance, overtime, and leave management. Free plan for up to 6 users!",
  keywords: [
  ...
  openGraph: {
    ...
    description: 'Planopia is a modern online time tracking app for businesses. Automate working hours, overtime, and leave management. Free for teams up to 6 users.',
    images: [
      {
  ...
  twitter: {
    ...
    title: 'Online Time Tracking – modern solutions for businesses | Planopia',
    description: 'Discover Planopia – a simple and powerful app for online time tracking, attendance, and leave management. Free plan available for up to 6 users.',
