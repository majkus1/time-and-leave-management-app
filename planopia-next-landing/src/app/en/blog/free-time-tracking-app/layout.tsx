...
export const metadata: Metadata = {
  ...
  description: "Discover Planopia - a free time tracking app for work hours and leave management for teams up to 6 people. Full functionality without any costs. Start today!",
  keywords: [
  ...
  openGraph: {
    ...
    siteName: 'Planopia',
    title: 'Free Time Tracking App for Work Hours and Leave Management | Planopia',
    description: 'Planopia is a free time tracking app for work hours and leave management. Full functionality for teams up to 6 people. No hidden fees, no time limits.',
    images: [
      {
  ...
  twitter: {
    ...
    title: 'Free Time Tracking App for Work Hours and Leave Management | Planopia',
    description: 'Discover Planopia - a free time tracking app for work hours. Full functionality for teams up to 6 people. Start today!',
