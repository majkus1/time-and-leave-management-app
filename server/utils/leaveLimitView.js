...
//
// Bez tej opcji User.leaveTypeDays to ROCZNA PULA, a „pozostało" wychodzi
...
//
// Bliźniaczy plik: client/src/utils/leaveLimitView.js — zmiany trzymać zgodnie.
const { convertLeaveAmount } = require('./leaveSettlement')
 ...
 */
function sumAutoDeductedAmount(requests, typeId, targetUnit, hoursPerDay) {
 ...
 * @param {Object} params
 * @param {Number} params.storedValue - User.leaveTypeDays dla typu
 ...
 */
function resolveLeaveLimitView({ storedValue, used = 0, pending = 0, autoDeducted = 0, autoMode = false }) {
...
module.exports = {
	sumAutoDeductedAmount,
	resolveLeaveLimitView,
}
