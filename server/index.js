...
const workActivityRoutes = require('./routes/workActivityRoutes')
...
const aiHelpRoutes = require('./routes/aiHelpRoutes')
...
app.use('/api/ai-help', aiHelpRoutes) // tryb „jak działa Planopia” — poza modułem planu i limitem AI
